...
def einzelwortsuche(Liste, Schlagwort):
    ...
    for Eintrag in Liste:
        if Eintrag == Schlagwort:
            Anzahl += 1
    return Anzahl

#Zählt die Anzahl der Schlagwörter im Urteilstext
def woertersuche(Liste):
    Schlagwortdict = {'entstehungsgeschicht': 1.5, 'systemat': 1.5, 'rechtsfehl': 1.5, 'wissenschaft': 1.5, 'standige rechtsprech': 2.5, 'definition': 1.5, 'bundesgerichtshof': 1, 'kontrov': 1.5, 'beschluss': 1, 'begriff': 1.5, 'schriftum': 1.5, 'normzweck': 1.5, 'histor': 1.5, 'olg': 1, 'oberlandesgericht': 1, 'gesetzgeber': 1.5, 'wortlaut': 1.5, 'bgh': 1, 'bundesverfassungsgericht': 1, 'zweck': 1, 'bverfg': 1, 'rechtsauffass': 1.5, 'reichsgericht': 1, 'stand. rspr.': 2.5, 'es kommt nicht darauf an': 0.5, 'gefestigte rechtsprech': 2.5, 'defini': 1.5, 'teleolog': 1.5, 'teil der literatur': 1.5, 'gesetzgeb': 1.5, 'auffass': 1.5, 'rechtsprech': 1, 'ausleg': 1.5, 'umstritt': 1.5, 'lasst ausser acht': 0.5, 'schutzzweck': 1.5, 'telos': 1.5, 'ansicht': 1.5, 'teleologi': 1.5, 'strspr': 2.5, 'sprachgebrauch': 1.5, 'senat': 1, 'sprachsinn': 1.5, 'st. rspr.': 2.5, 'sinn und zweck': 1.5, 'urteil': 1}
...
def Rankingnummer(Absatzobjekt):
    ...
    return (Auswertung_Schlagwoerter + sum(Auswertung_Zitate))
